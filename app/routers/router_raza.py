...
from app.controllers.raza_controller import (
    create_raza, obtener_raza, obtener_razas, actualizar_raza, eliminar_raza
)
...
def obtener_todas_las_razas_endpoint(db: Session = Depends(get_db)):
    return obtener_razas(db)

# 3. OBTENER UNA POR ID (Las rutas con parámetros dinámicos van ABAJO)
